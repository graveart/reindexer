...
Error Reindexer::SubscribeUpdates(IUpdatesObserver* observer, const UpdatesFilters& filter, SubscriptionOpts opts) {
	return impl_->SubscribeUpdates(observer, filter, opts);
}
